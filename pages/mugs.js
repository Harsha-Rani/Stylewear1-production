    ...
    <section className="text-gray-600 body-font min-h-screen">
      <div className="container px-5 py-24 md:ml-[5vh] md:mr-[7vh] mx-auto">
        <div className="flex flex-wrap w-screen">
          {Object.keys(prod).length === 0 && <p>Sorry, all mugs are currently out of stock. New stock comming soon. Stay Tuned!!</p>}
            ...
            <Link passHref={true} href={`/product/${prod[item].slug}`}><div className="block relative rounded overflow-hidden">
              ...
              <div className="mt-4 text-center md:text-left">
                ...
                <p className="mt-1">
                  ...
                  {prod[item].color.includes('gray') && <button className="border-2 border-gray-300 ml-1 bg-gray-500 rounded-full w-6 h-6 focus:outline-none"></button>}
                  {prod[item].color.includes('blue') && <button className="border-2 border-gray-300 ml-1 bg-blue-600 rounded-full w-6 h-6 focus:outline-none"></button>}
