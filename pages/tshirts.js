            ...
            <Link passHref={true} href={`/product/${prod[item].slug}`}><div className="block relative rounded overflow-hidden">
              ...
              <div className="mt-4 text-center md:text-left">
                ...
                <p className="mt-1">
                  ...
                  {prod[item].color.includes('green') && <button className="border-2 border-gray-300 ml-1 bg-green-700 rounded-full w-6 h-6 focus:outline-none"></button>}
                  {prod[item].color.includes('blue') && <button className="border-2 border-gray-300 ml-1 bg-blue-950 rounded-full w-6 h-6 focus:outline-none"></button>}
                  {prod[item].color.includes('yellow') && <button className="border-2 border-gray-300 ml-1 bg-yellow-400 rounded-full w-6 h-6 focus:outline-none"></button>}
